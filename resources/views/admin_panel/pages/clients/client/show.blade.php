        ...
        <div class="boxshadow rounded mb-4">
            <div class="row justify-content-center m-0 py-1 boxshadow rounded">
                <div class="col-xl-12 col-lg-12 col-md-12 v-center">
                    <div class="">
                        <h2 class="  m-0">Customer Profile</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="row  py-3">
            <div class="col-md-5 view_designwala_profileCol">
                <div class="card mb-3" style="">
                    <div class="row no-gutters">
                        <div class="col-lg-4 col-md-3 v-center text-center">
                            <div class="customerProfileClientImg"><img src="img/devimg/headermanlogo.png"
                                                                       class="card-img " alt="..."></div>
                        </div>
                        <div class="col-lg-8 col-md-9  v-center">
                            <div class="card-body">
                                <h4 class="card-title">CLIENT NAME <span data-toggle="tooltip" data-placement="top"
                                                                         title="Verified"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 18 18">
                                            <g transform="translate(-800 -372)">
                                                <circle cx="9" cy="9" r="9" transform="translate(800 372)"
                                                        fill="#038d08"/>
                                                <g transform="translate(804 367.557)">
                                                    <path
                                        ...
                                        </svg></span> <span data-toggle="tooltip" data-placement="top"
                                                            title="Verified"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="22.225" height="18.251"
                                            viewBox="0 0 22.225 18.251">
                                            <path
                                                ...
                                                transform="translate(0 -41.727)" fill="red"/>
                                        </svg></span></h4>
                                <h4 class="card-title">CLIENT ID</h4>
                                <p class="card-text mb-0"><b>Your Order ID :</b> XYZ</p>
                                <p class="card-text mb-0"><b>Total Spent : </b> $110 </p>
                                <h5 class=""> Balance : <span class="colorOne"> $50 </span></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 view_designwala_profileCol">
                <div class="card rounded p-3 cardAddressDetails">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="29.988" height="19.992"
                                ...
                                <g transform="translate(0 0)">
                                    <path
                                        ...
                                        transform="translate(0 -85.333)" fill="#2d2d2d"/>
                                </g>
                                <g transform="translate(2.5 2.499)">
                                    <path
                                        ...
                                        transform="translate(-42.67 -128)" fill="#2d2d2d"/>
                                </g>
                                <g transform="translate(2.498 9.996)">
                                    <g transform="translate(0 0)">
                                        <path
                                            d="M51.249,256.22a.628.628,0,0,0-.881-.08l-7.5,6.247a.625.625,0,0,0,.8.961l7.5-6.247A.626.626,0,0,0,51.249,256.22Z"
                                            transform="translate(-42.646 -255.996)" fill="#2d2d2d"/>
                                    </g>
                                </g>
                                <g transform="translate(18.742 9.996)">
                                    <path
                                        d="M328.524,262.386l-7.5-6.247a.625.625,0,0,0-.8.961l7.5,6.247a.625.625,0,1,0,.8-.961Z"
                                        transform="translate(-320.001 -255.995)" fill="#2d2d2d"/>
                                </g>
                            </svg></span> username@gmail.com
                    </p>
                    <p><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="27.584" height="26.496"
                                 viewBox="0 0 27.584 26.496">
                                <g transform="translate(0 26.496) rotate(-90)">
                                    <g transform="translate(0 0)">
                                        <path
                    ...
                    <p class="mb-0"><span><svg xmlns="http://www.w3.org/2000/svg" width="26.814" height="26.239"
                            ...
                            </svg></span> Road no., Block no., District, Country
                    </p>
                </div>
            </div>
            <div class="col-md-3 view_designwala_profileCol">
                <div class="card text-center">
                    <h5>Joined : 6 Months Ago</h5>
            ...
            <div class="row m-0 py-3">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-4 col-md-5"> status
                    ...
                    <div class="designwalsDataTables text-center">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>XYZ</td>
                                <td> Logo Design</td>
                                <td> $100 <span class="text-danger"> &#40; -$20 &#41; </span></td>
                                <td>Bkash</td>
                                <td>
