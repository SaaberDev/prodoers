                ...
                <div class="col-md-3">
                    <div class="">
                        <div class="card" style="">
                            <div class="card-body">
                                <h5 class="card-title">Edit Meta</h5>
                                <hr>
                                <form>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">property</label>
                                        <input type="text" value="edit_value" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="designwalsDataTables text-center border">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <a href="{{ route('settings.seo_tools.open_graph.edit_open_graph') }}" class="btn p-0 m-0" data-toggle="tooltip" title="" data-original-title="view or edit">
