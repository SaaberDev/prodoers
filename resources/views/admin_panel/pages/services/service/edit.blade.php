                ...
                <div class="row m-0 justify-content-between">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_desc" class="form-control editor {{ $errors->has('short_desc') ? ' is-invalid' : '' }}" id="short_desc" rows="5">{!! old('short_desc', $service->short_desc) !!}</textarea>
...
@push('scripts')
    ...
    @include('plugins.tiny-mce.tinymce')
@endpush
