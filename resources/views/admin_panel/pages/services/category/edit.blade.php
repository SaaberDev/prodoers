...
@section('content')
    <div class="col-xl-10 col-lg-9 col-md-12 dashboardRightside scrollbar scroll-style">
        ...
        <div class="mt-4">
            <form action="{{ route('super_admin.service.category.update', $id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PATCH')
                                    ...
                                    <div class="col-md-12">
                                        <div  class="input-group  mb-0">
                                            ...
                                            <div class="input-group-append">
                                                <a type="button" data-id="{{ $faq->id }}" data-action="{{ route('super_admin.service.category.destroyServiceCategoryFaq', $faq->id) }}" {{--href="{{ route('services.category.destroyServiceCategoryFaq', $faq->id) }}"--}} class="btn sweet_delete p-0 m-0">
