        ...
        <div class="boxshadow rounded">
            <div class="row justify-content-center m-0 py-1 boxshadow rounded">
                <div class="col-xl-9 col-lg-8 col-md-8 v-center">
                    <div class="">
                        <h2 class="  m-0">Permissions</h2></div>
                </div>
            ...
            <div class="row m-0 py-3 bg-white ">
                ...
                <div class="col-md-9 ">
                    <div class="designwalsDataTables text-center border">
                        <h5 class="text-left pt-4 pl-4">Permissions</h5>
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>01</td>
                                <td>
                                    <div class="tableDataLastButtonLiketab  tabletabCREEAM text-dark"><span class=""> Create</span>
                                    </div>
                                </td>
                                <td>09.09.20</td>
                                <td>
                                    <div class="">
                                        <a href="#" class="btn p-0 m-0" data-toggle="tooltip" title=""
                            ...
                            <tr>
                                <td>01</td>
                                <td>
                                    <div class="tableDataLastButtonLiketab  tabletabCREEAM text-dark"><span class=""> Read</span>
                                    </div>
                                </td>
                                <td>09.09.20</td>
                                <td>
                            ...
                            <tr>
                                <td>01</td>
                                <td>
                                    <div class="tableDataLastButtonLiketab  tabletabCREEAM text-dark"><span class=""> Update</span>
                                    </div>
                                </td>
                                <td>09.09.20</td>
                                <td>
                            ...
                            <tr>
                                <td>01</td>
                                <td>
                                    <div class="tableDataLastButtonLiketab  tabletabCREEAM text-dark"><span class=""> Delete</span>
                                    </div>
                                </td>
                                <td>09.09.20</td>
                                <td>
