        ...
        <div class="boxshadow rounded">
            <div class="row justify-content-center m-0 py-1 boxshadow rounded">
                <div class="col-xl-9 col-lg-8 col-md-8 v-center">
                    <div class="">
                        <h2 class="  m-0">Advertisement Banner</h2>
                    </div>
                </div>
            ...
            <div class="row m-0 py-3 bg-white ">
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="edit_title" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class="mt-4 border">
                                        <ul class=" list-unstyled previewimg">
                                            <li class="col-md-10 py-4 text-center position-relative m-auto">
                                                <div class=""><img src="{{ asset('img/rectangle.png') }}" alt="" id=""
                                                                   style="width:100%;">
                ...
                <div class="col-md-9 ">
                    <div class="designwalsDataTables text-center border">
                        <h5 class="text-left pt-4 pl-4">Advertisement Banner
                        </h5>
