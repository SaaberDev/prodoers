...
@section('content')
    <div class="col-xl-10 col-lg-9 col-md-12 dashboardRightside scrollbar scroll-style">
        ...
        <div class="SectionDataTable rounded">
                    ...
                    <div class="designwalsDataTables text-center">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>4 out of 5</td>
                                <td>
                                    <div class="tableDataLastButtonLiketab  tabletabRED"><span class="">pending</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="">
                                        <button data-toggle="modal" data-target="#reviewmodal" class="btn p-0 m-0">
    ...
    @include('admin_panel.includes.modal.show_review')
@endsection
