    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-3 v-center text-center">
                <div class="text-center"> <img src="{{ asset('_assets/_admin_panel/img/designwalalogo.svg') }}" class="img-fluid w-75" alt=""> </div>
            </div>
                ...
                <div class="adminNav ">
                    <ul class="nav headerNavlinks">
                        <li class="nav-item dropdown v-center">
                            <a href="https://frontend.designwala.net" class="nav-link " target="_blank" data-toggle="tooltip" title="visit frontend">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 8.595 8.595">
                                    <path d="M277.147,121a4.145,4.145,0,0,0-2.965,7.045.469.469,0,0,0,.067.067,4.146,4.146,0,1,0,2.9-7.112Zm2.621,3.432h-1.906v-1.906A2.727,2.727,0,0,1,279.768,124.432Zm-3.336-1.906v2.325l-1.643,1.643A2.718,2.718,0,0,1,276.432,122.526Zm-.632,4.979,1.643-1.643h2.325A2.718,2.718,0,0,1,275.8,127.506Z" transform="translate(-272.85 -120.85)" fill="#000" stroke="#fff" stroke-width="0.3" />
                                </svg>
                            </a>
                        </li>
                        <li class="nav-item dropdown v-center position-relative">
                            <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="{{ asset('_assets/_admin_panel/img/bellicon.svg') }}" class="img-fluid" alt=""> <span class="notify">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14" viewBox="0 0 14 14">
                                            ...
                                            <g id="Group_1000" data-name="Group 1000" transform="translate(-1758 -23)">
                                                <circle id="Ellipse_177" data-name="Ellipse 177" cx="7" cy="7" r="7" transform="translate(1758 23)" fill="url(#radial-gradient)" />
                                                <circle id="Ellipse_176" data-name="Ellipse 176" cx="4" cy="4" r="4" transform="translate(1761 26)" fill="#ff0404" />
                                            </g>
                                        </svg>
                                    </span> </a>
                            <div class="dropdown-menu profile_dropdown" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="#">Your Name</a>
                        ...
                        <li class="nav-item dropdown v-center">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="{{ asset('_assets/_admin_panel/img/headermanlogo.png') }}" alt="" class="img-fluid"> </a>
                            <div class="dropdown-menu profile_dropdown" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="#">Your Name <span><img src="{{ asset('_assets/_admin_panel/img/headermanlogo.png') }}" alt="" height="30" width="30"></span></a>
                                <div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Another action</a> <a class="dropdown-item" href="#">Something else here</a> </div>
                        </li>
                        <li class="nav-item dropdown v-center">
