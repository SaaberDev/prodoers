...
<header class="designwalaHeader d-lg-none d-sm-block" id="designwalaHeader">
    <nav class="navbar navbar-expand-lg navbar-dark designwalaNavbarColor">
        <div class="container">
            <a class="navbar-brand text-white font-weight-bold" href="{{ route('guest.home.index') }}">
                <img class="img-fluid img-2" src="{{ asset('_assets/_guest/img/final-logo.svg') }}" alt="">
            </a>
            <button data-trigger="#navbar_main" class="d-lg-none btn bg-whit2" type="button"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-ui-radios-grid" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
{{--                <h2 class="py-2 px-3">Designwala</h2>--}}
                <a class="navbar-brand text-black-50 font-weight-bold py-2 px-3" href="{{ route('guest.home.index') }}">ProDoers</a>
            </div>
            <ul class="nav bd-links flex-column ">
                <!--service-->
                <li class="nav-item clearfix">
                    <a class="nav-link collapsed " data-bs-toggle="collapse" href="#services" role="button" aria-expanded="false"> Services
