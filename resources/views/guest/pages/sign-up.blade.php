                ...
                <div class="col-md-12">
                    <div>
                        ...
                        <form class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                <input type="password" class="form-control login_pass " id="exampleInputPassword1" placeholder="Password">
                            </div>
                            <div class="mb-3 col-md-12">
                                <input type="password"  class="form-control login_confirm_pass " id="exampleInputPassword1" placeholder="Confirm Password">
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label agreement" style="font-size: 15px">
                                        ...
                                        <span><a href="http://127.0.0.1:8000/terms-and-conditions" class="btn btn-link m-0 p-0" style="font-size: 15px; color: #000000; font-weight: 600;" type="button" target="_blank"> Terms &amp; Condition</a></span> and
                                        <span><a href="http://127.0.0.1:8000/privacy-policy" class="btn btn-link m-0 p-0" style="font-size: 15px; color: #000000; font-weight: 600;" type="button" target="_blank">Privacy Policy</a>, as well as receive promotional emails.</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="text-center forgotPass">
                            <h6>Already a member?
                                <a class="btn colorOne px-0" href="#">Sign In</a>
                            </h6>
                        </div>
                    </div>
                </div>
