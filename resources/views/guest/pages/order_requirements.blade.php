                    ...
                    <div class="w-100 ">
                        ...
                        <div class="w75cartdiv ">
                            <div class="">
                                ...
                                <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis,
                                    recusandae.</p>
                                <p class=" m-0 font-weight-bold text-dark"><span class="small"> Price :</span>
                                    <span>$50</span> <span class="text-danger"> &#40; - $10 &#41; </span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12">
                    <form class="row g-3 needs-validation" novalidate>
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control rounded-0 is-valid" id="validationCustom01" value=""
                                   placeholder="Brand Name*" required>
                            <div class="valid-feedback"> Looks good!</div>
                        </div>
                        <div class="col-md-12">
                            <!--    <label for="validationCustom02" class="form-label">Tagline</label>-->
                            <input type="text" class="form-control rounded-0 is-invalid" id="validationCustom02"
                                   value="" placeholder="Tagline" required>
                            <div class="valid-feedback"> Looks good!</div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="position-relative" style="">
                                        <input type="text" class="form-control rounded-0 is-valid" id="" value=""
                        ...
                        <div class="col-md-12 pt-3">
                            ...
                            <div class="form-group d-lg-none d-md-block">
                                <div class="form-check text-center">
                                    <input class="form-check-input float-none" type="checkbox" id="gridCheck" style="margin-right: 9px;">
                                    <label class="form-check-label paymentdetailsCheck" for="gridCheck" style="display: inline;">
                                        I agreed to <span class="">Designwala  <br> </span> <span><button
                                                class="btn btn-link m-0 p-0" type="button" data-toggle="modal"
                                                data-target="#exampleModal-1"> Terms &amp; Condition</button></span> and
                                        <span><button class="btn btn-link m-0 p-0" type="button" data-toggle="modal"
                                                      data-target="#exampleModal-2">Privacy Policy</button></span>
                            ...
                            <div class="text-center p-3">
                                <button class="btn  bgOne text-white rounded-0 px-5 py-2" type="submit"
                                        data-toggle="modal" data-target="#signUp">Continue
                                </button>
                            </div>
                        </div>
