    ...
    <div class="requirement-accordion">
        <div class="accordion" id="revisionAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header accordion-header-text" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    Revision
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapsec show" aria-labelledby="headingTwo" data-bs-parent="#revisionAccordion">
