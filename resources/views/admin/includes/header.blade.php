    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-3 v-center text-center">
                <div class="text-center"> <img src="img/DESIGNWALA.svg" class="img-fluid w-75" alt=""> </div>
            </div>
                ...
                <div class="adminNav ">
                    <ul class="nav headerNavlinks">
                        ...
                        <li class="nav-item dropdown v-center position-relative">
                            <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="img/dashboardHOme/bellicon.svg" class="img-fluid" alt=""> <span class="notify">
                        ...
                        <li class="nav-item dropdown v-center">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="img/Ellipse%20160.png" alt="" class="img-fluid"> </a>
                            <div class="dropdown-menu profile_dropdown" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="#">Your Name <span><img src="img/Ellipse%20160.png" alt="" height="30" width="30"></span></a>
                                <div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Another action</a> <a class="dropdown-item" href="#">Something else here</a> </div>
                        </li>
                        <li class="nav-item dropdown v-center">
