            ...
            @forelse($services as $service)
                <div class="col-lg-4 col-md-6 padding25">
                    <div class="searchPageResultSingle position-relative">
                        <div class="card "> <img src="{{ asset($service->thumbnail ? $service_thumbnail . $service->thumbnail : config('designwala_paths.default.no_preview')) }}" class="card-img-top" alt="..." loading="lazy">
                            <div class="card-body">
                                <h5 class="card-title ">
