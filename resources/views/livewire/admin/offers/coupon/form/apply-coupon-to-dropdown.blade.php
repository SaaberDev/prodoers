        ...
        <div class="form-group">
            ...
            <div wire:ignore>
                <select wire:model="applyTo"
                        name="apply_to"
                        id="apply_to"
                        class="js-states select2 form-control {{ $errors->has('apply_to') ? ' is-invalid' : '' }}"
                >
                    <option></option>
            ...
            <select class="js-states select2 form-control {{ $errors->has('services') || $errors->has('categories') ? ' is-invalid' : '' }}"
                    wire:model="selected"
                    id="dropdown"
