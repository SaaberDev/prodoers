@forelse($service_category->serviceCategoryFaqs as $faq)
    <div id="dynamic-field-multiple-{{ $loop->iteration }}" class="row dynamic-field-multiple" wire:key="{{ $loop->index }}">
        <div class="col-md-12 mt-3">
            ...
            <div class="input-group-append">
                ...
                <a type="button"
                   id="sweet_delete"
                   href="{{ route('super_admin.service.category.destroyFaq', $faq->id) }}"
