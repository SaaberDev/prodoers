                    ...
                    <table class="table table-hover">
                        ...
                        @forelse($service_categories as $service_category)
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <a href="{{ route('super_admin.service.category.edit', $service_category->id) }}" class="btn p-0 m-0" data-toggle="tooltip" title="" data-original-title="view or edit">
                                        ...
                                        <a data-action="{{ route('super_admin.service.category.destroy', $service_category->id) }}" class="sweet_delete btn m-0 p-0">
