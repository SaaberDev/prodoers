                    ...
                    <table class="table table-hover">
                        ...
                        @forelse($social_links as $social_link)
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <a href="{{ route('settings.site_cms.social_link.edit', $social_link->id) }}" class="btn p-0 m-0" data-toggle="tooltip" title="" data-original-title="view or edit">
                                        ...
                                        <a data-action="{{ route('settings.site_cms.social_link.destroy', $social_link->id) }}" class="sweet_delete btn m-0 p-0">
