                ...
                <div class="designwalsDataTables text-center">
                    <table class="table table-hover">
                        ...
                        @forelse($social_links as $social_link)
                            <tr>
                                <td><img src="{{ asset(config('designwala_paths.show.site_cms.social_icon') . $social_link->social_icon) }}" alt="" class="img-fluid" style="height: 25px;"> </td>
                                <td>{{ $social_link->social_title }}</td>
                                <td>{{ $social_link->social_url }}</td>
                                <td>{{ formatDMY($social_link->updated_at) }}</td>
                                <td>
                                    <div class="">
                                        <a href="{{ route('super_admin.settings.site_cms.social_link.edit', $social_link->id) }}" class="btn p-0 m-0" data-toggle="tooltip" title="" data-original-title="view or edit">
                                        ...
                                        <a data-action="{{ route('super_admin.settings.site_cms.social_link.destroy', $social_link->id) }}" class="sweet_delete btn m-0 p-0">
