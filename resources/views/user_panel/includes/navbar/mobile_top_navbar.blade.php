<header class="designwalaHeader d-lg-none d-sm-block" id="designwalaHeader">
    <nav class="navbar navbar-expand-lg navbar-dark designwalaNavbarColor">
        <div class="container"> <a class="navbar-brand text-white font-weight-bold" href="index.html">DESIGNWALA</a>
            <button data-trigger="#navbar_main" class="d-lg-none btn bg-white" type="button"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-ui-radios-grid" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container">
        ...
        <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg navbar-dark bg-white d-lg-none d-sm-block shadow">
            ...
            <ul class="nav bd-links flex-column ">
                <!--                     dashboard -->
                <!--service-->
                <li class="nav-item clearfix"> <a class="nav-link collapsed " data-toggle="collapse" href="#services" role="button" aria-expanded="false"> Services <span class="nav-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="28" viewBox="0 0 11 28">
                    ...
                    <div class="collapse" id="services" style="">
                        <ul class="list-unstyled font-weight-normal pb-1 ">
                            <li class="nav-item sub-item"> <a href="./index.html" class="nav-link d-inline-flex align-items-center sub-menu-link pl-4 active"> index </a> </li>
                            ...
                            <li class="nav-item sub-item"> <a href="./searchPage.html" class="nav-link d-inline-flex align-items-center sub-menu-link pl-4"> Search </a> </li>
                            <li class="nav-item sub-item"> <a href="./singleCategory.html" class="nav-link d-inline-flex align-items-center sub-menu-link pl-4"> Single Category </a> </li>
                            <li class="nav-item sub-item"> <a href="./singleCategoryItem.html" class="nav-link d-inline-flex align-items-center sub-menu-link pl-4"> Category Item </a> </li>
                        </ul>
                    </div>
                </li>
                <!--service end -->
                ...
                <li class="nav-item">
                    <button id="singinbutton" type="button" class="btn" data-toggle="modal" data-target="#signIn">Sign In</button>
                </li>
                <li class="nav-item">
