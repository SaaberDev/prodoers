<header class="designwalaHeader d-none d-lg-block" id="designwalaHeader">
    <nav class="navbar navbar-hover navbar-expand-lg navbar-dark designwalaNavbarColor">
        <div class="container" style="position: relative;"> <a href="{{ route('guest.home.index') }}" class="navbar-brand text-white font-weight-bold">DESIGNWALA</a>
            ...
            <div class="collapse navbar-collapse" id="main_nav99">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu profile_dropdown" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="#">Your Name <span><img src="#" alt=""></span></a>
