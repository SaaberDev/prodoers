<?php
    namespace App\Packages\SslCommerz;
...
//                    $this->redirect($formattedResponse['redirectGatewayURL'] . $formattedResponse['gw']['mobilebanking']);
                } else {
        ...
        public function setRequiredInfo(array $info)
        {
            ...
            $this->data['currency'] = 'BDT';/*$info['currency'];*/ // string (3)	Mandatory - The currency type must be mentioned. It shall be three characters. Example : BDT, USD, EUR, SGD, INR, MYR, etc. If the transaction currency is not BDT, then it will be converted to BDT based on the current convert rate. Example : 1 USD = 82.22 BDT.
